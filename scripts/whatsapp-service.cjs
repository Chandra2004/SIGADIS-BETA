 ...
 * 2. Jalankan service: npm run whatsapp:service (atau node scripts/whatsapp-service.cjs)
 ...
 * - Lewat Terminal: npm run whatsapp:logout (atau node scripts/whatsapp-service.cjs --logout)

...
//         Route::get('/daftar', [StaffAuthController::class, 'showRegisterForm'])->name('auth.staff.register.show');
//         Route::post('/daftar', [StaffAuthController::class, 'register'])->name('auth.staff.register');
...
//         Route::get('/menunggu-verifikasi', [StaffAuthController::class, 'pending'])->name('auth.staff.pending');
//         Route::post('/logout', [StaffAuthController::class, 'logout'])->name('auth.staff.logout');
